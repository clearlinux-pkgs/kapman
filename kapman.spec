...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kapman-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kapman-24.05.1.tar.xz.sig
...
%setup -q -n kapman-24.05.1
cd %{_builddir}/kapman-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718406482
mkdir -p clr-build
pushd clr-build
