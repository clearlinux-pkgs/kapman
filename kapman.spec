...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/kapman-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/kapman-22.12.0.tar.xz.sig
...
%prep
%setup -q -n kapman-22.12.0
cd %{_builddir}/kapman-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670533261
mkdir -p clr-build
pushd clr-build
