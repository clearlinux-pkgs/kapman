...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kapman-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kapman-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kapman-24.02.0
cd %{_builddir}/kapman-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710301432
mkdir -p clr-build
pushd clr-build
