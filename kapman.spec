...
Version  : 21.08.1
Release  : 30
URL      : https://download.kde.org/stable/release-service/21.08.1/src/kapman-21.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.1/src/kapman-21.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.1/src/kapman-21.08.1.tar.xz.sig
...
%prep
%setup -q -n kapman-21.08.1
cd %{_builddir}/kapman-21.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630906971
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kapman-21.08.1/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kapman/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kapman-21.08.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kapman/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang kapman
