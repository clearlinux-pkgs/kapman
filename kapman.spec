...
Version  : 22.12.1
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.12.1/src/kapman-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kapman-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kapman-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kapman-22.12.1
cd %{_builddir}/kapman-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673297866
mkdir -p clr-build
pushd clr-build
