...
Version  : 19.12.1
Release  : 16
URL      : https://download.kde.org/stable/release-service/19.12.1/src/kapman-19.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kapman-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kapman-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kapman-19.12.1
cd %{_builddir}/kapman-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578603039
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kapman-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/kapman/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kapman-19.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kapman/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kapman
