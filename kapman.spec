...
Version  : 22.08.3
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.08.3/src/kapman-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/kapman-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/kapman-22.08.3.tar.xz.sig
...
%prep
%setup -q -n kapman-22.08.3
cd %{_builddir}/kapman-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667877268
mkdir -p clr-build
pushd clr-build
