...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kapman-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kapman-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kapman-23.08.2
cd %{_builddir}/kapman-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697252758
mkdir -p clr-build
pushd clr-build
