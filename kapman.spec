...
Source0  : https://download.kde.org/stable/applications/18.12.3/src/kapman-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/kapman-18.12.3.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1551984704
mkdir -p clr-build
pushd clr-build
