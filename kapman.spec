...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kapman-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kapman-24.08.0.tar.xz.sig
...
%setup -q -n kapman-24.08.0
cd %{_builddir}/kapman-24.08.0
pushd ..
cp -a kapman-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724524276
mkdir -p clr-build
pushd clr-build
